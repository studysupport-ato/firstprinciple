...
export default async function LessonPage({ params, searchParams }: LessonPageProps) {
  ...
  return <LessonExperience lesson={result.lesson} courseId={route.courseId} preview={query.preview === "1"} week={query.week} supplementaryResources={supplementaryResources} />;
}
